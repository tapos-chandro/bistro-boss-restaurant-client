...
const SideBar = () => {
    return (
        <div className="lg:w-60 bg-[#C2924D] text-black lg:h-screen px-4 py-6 space-y-6">
            ...
            <ul className="space-y-4">
                ...
                <li><NavLink to="/cart" className="flex items-center gap-2"><FaShoppingCart /> My Cart</NavLink></li>
            ...
            <ul className="space-y-4">
                <li><Link to="/home" className="flex items-center gap-2"><FaHome /> Home</Link></li>
